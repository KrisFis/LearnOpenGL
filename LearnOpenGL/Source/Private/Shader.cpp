	...
	, bIsInitialized(false)
{
	...
	std::string fullVertexPath = std::string("../../Shaders/Vertex/") + std::string(VertexFilename);
	std::string fullFragmentPath = std::string("../../Shaders/Fragment/") + std::string(FragmentFilename);
